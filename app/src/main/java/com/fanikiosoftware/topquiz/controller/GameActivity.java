...
public class GameActivity extends AppCompatActivity implements OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       //has data been persisted? if so, get data (score and questions)
        ...
        //region onClickListener Implementation for answer buttons
        @Override
        ...
        public QuestionBank generateQuestions () {
            ...
            Question question8 = new Question("What organization does Everett" +
                    ...
                    Arrays.asList("Joint Counter Fighting Task Force",
                            "SHIELD",
                            "The CIA",
                            "S.W.O.R.D."),
                    2);
            ...
            Question question10 = new Question("What is Shuri's relationship with T'Challa?",
                    Arrays.asList("She's his older sister",
                            "She's his aunt",
            ...
            Question question13 = new Question("Ulysses Klaue is one of the film's bad" +
                    ...
                    Arrays.asList("Captain America: The Winter Soldier",
                            ...
                            "Big Poppa Chuckles: The Fourth Avenger"),
                    2);
            Question question14 = new Question("Vibranium is the source of Wakanda's technology -" +
                    " and it's also what Captain America's shield is made out of! What makes it special?",
                    Arrays.asList("It can shoot electricity",
                            "It's super magnetic",
                            "It's super sparkly",
        ...
        //region endGame implementation , bundle score for main activity
